...
function New-Certificate
{
    ...
    $serial = Get-Random
    $expiryDate = [datetime]::Now.AddYears(10).ToString("MM/dd/yyyy")
    .\makecert -r -pe -n CN=$HostName -b 01/01/2012 -e $expiryDate -eku 1.3.6.1.5.5.7.3.1 -ss my -sr localmachine -sky exchange -sp "Microsoft RSA SChannel Cryptographic Provider" -sy 12 -# $serial 2>&1 | Out-Null
