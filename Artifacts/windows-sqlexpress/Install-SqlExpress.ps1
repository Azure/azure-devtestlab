...
try
{
    Write-Output 'Downloading and Installing SQL Server Express'
    ...
    & ".\Downloads\$OutFile" /ENU /IACCEPTSQLSERVERLICENSETERMS /QUIET
    # Remove-Item -Path ".\Downloads\$OutFile" -Force
}
finally
{
    popd
