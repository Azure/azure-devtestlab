...
# Find the DevTest Lab
$lab = Get-AzureRmResource -ResourceId (Find-AzureRmResource -ResourceNameEquals $DevTestLabName -ResourceType "Microsoft.DevTestLab/labs").ResourceId -ApiVersion "2017-04-26-preview"
