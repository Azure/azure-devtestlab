...
function GenerateMasterSQLTable($indfile, $sqlConn, $tableName) {
...
{
    Write-Output "Generating table using file $indFile"
    GenerateMasterSQLTable -indfile $indFile -sqlConn $sqlConn -tableName "MasterVMData"
...
{
    Write-Output "Generating table using file $indFile"
    GenerateMasterSQLTable -indfile $indFile -sqlConn $sqlConn -tableName "MasterDiskData"
...
#SQL Create table LabDetails ===========================================================================================================================

$datafiles = Get-ChildItem -LiteralPath $localStore -File -Filter "labdetails.csv" -Recurse

Write-Output "Starting MasterLabData, file count: $($datafiles.Count.ToString())"

foreach ($indFile in $datafiles)
{
    Write-Output "Generating table using file $indFile"
    GenerateMasterSQLTable -indfile $indFile -sqlConn $sqlConn -tableName "MasterLabData"

    #Remove temp files
    $indfile.Delete()
}

Write-Output "Ending MasterLabData"

#SQL Create table VMDetails ===========================================================================================================================

$datafiles = Get-ChildItem -LiteralPath $localStore -File -Filter "vmdetails.csv" -Recurse

Write-Output "Starting MasterVMDetailsData, file count: $($datafiles.Count.ToString())"

foreach ($indFile in $datafiles)
{
    Write-Output "Generating table using file $indFile"
    GenerateMasterSQLTable -indfile $indFile -sqlConn $sqlConn -tableName "MasterVMDetailsData"

    #Remove temp files
    $indfile.Delete()
}
Write-Output "Ending MasterVMDetailsData"
